...
from external.stoix.utils.env_factory import EnvFactory
from external.stoix.utils.jax_utils import unreplicate_batch_dim
...
def get_ff_evaluator_fn(
    ...
    def eval_one_episode(params: FrozenDict, init_eval_state: EvalState) -> Dict:
        ...
        } | final_state.timestep.extras["episode_metrics"]  # AL: added this to have custom metrics
