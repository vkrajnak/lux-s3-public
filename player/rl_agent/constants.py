...
ENV_PARAMS_RANGES = dict(
    # map_type=[1],
    unit_move_cost=list(range(1, 6)),  # known
    unit_sensor_range=[1, 2, 3, 4],  # known
    nebula_tile_vision_reduction=list(range(0, 8)),
    nebula_tile_energy_reduction=[0, 1, 2, 3, 5, 25],
    unit_sap_cost=list(range(30, 51)),  # known
    unit_sap_range=list(range(3, 8)),  # known
